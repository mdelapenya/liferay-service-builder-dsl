...
public abstract class BaseColumnTest {
	...
	public void testBuild() {
		...
		checkFilterPrimary(column.isFilterPrimary());
	...
	public void testBuildWithoutLazyFetchFromNonBlobField() {
		ColumnBuilder builder = getDefaultColumnBuilder(
	...
	public void testEquals() {
		Column column1 = getDefaultColumnBuilder(
			"companyId", ServiceBuilderType.LONG).build();
		Column column2 = getDefaultColumnBuilder(
			"companyId", ServiceBuilderType.LONG).build();
	...
	public void testEqualsFilterPrimaryColumnDifferentName() {
		...
		Column column2 = getOppositeColumnBuilder(
			"companyId", ServiceBuilderType.LONG).build();
	...
	protected abstract void checkFilterPrimary(boolean filterPrimary);

	protected abstract ColumnBuilder getDefaultColumnBuilder(
		String name, ServiceBuilderType serviceBuilderType);

	protected abstract ColumnBuilder getOppositeColumnBuilder(
		String name, ServiceBuilderType serviceBuilderType);

	private ColumnBuilder builder = getDefaultColumnBuilder(
